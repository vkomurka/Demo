...
namespace Demo.WebServer.Migrations
{
    public partial class Initialization : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "InventoryOperationDetails",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryOperationDetails", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
                        name: "FK_InventoryOperationDetails_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InventoryOperationDetails_Uoms_UomId",
                        column: x => x.UomId,
                        principalTable: "Uoms",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InventoryOperationDetails_Warehouses_SourceWarehouseId",
                        column: x => x.SourceWarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InventoryOperationDetails_Warehouses_TargetWarehouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryOperationDetails_ProductId",
                table: "InventoryOperationDetails",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryOperationDetails_SourceWarehouseId",
                table: "InventoryOperationDetails",
                column: "SourceWarehouseId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryOperationDetails_TargetWarehouseId",
                table: "InventoryOperationDetails",
                column: "TargetWarehouseId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryOperationDetails_UomId",
                table: "InventoryOperationDetails",
                column: "UomId");
